...
The sample N reads appear to be highly dispersed, this causes the mean-sd values to result negative. After checking for normality the read depth threshold could be applied.
