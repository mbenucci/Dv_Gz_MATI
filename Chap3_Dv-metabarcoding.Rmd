...
layout(lay.matrix, heights=c(2,2,0.5), widths=c(2,2))
...
orditorp(ord, display="species", type="n")
plot(fit.oct, col="red", cex=1)
text(-1.4,1, label="D", cex=3)

# NOTE: Legend to be sorted into a 2x2 format!!!

plot.new()
legend("top", legend=c("Grafham Water","Wroxham Broad","Rockand Broad"), text.width=max(sapply(c("Grafham Water","Wroxham Broad","Rockand Broad"), strwidth)), col=c("blue","green","orange"), lwd=5, cex=1, horiz = TRUE)
dev.off()
```
