...
## FROM HERE!!!!
# NOTE: to find the right way to plot this data! (barplot?) Also to implement, alpha-div and raref. curves (need to transpose and sort sample names!) plus overlap between guts and eDNA. Next section kick-samples.

edna_inext = iNEXT(test.dcast, q=c(0,1), datatype = "abundance", se=T, endpoint=200)
