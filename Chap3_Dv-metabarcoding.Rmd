...
pdf("images/guts_predator_NMDS_euclidean.pdf")
...
# full symbols for May, hollow symbols for October
pdf("images/eDNA_NMDS_bray-curtis.pdf")
...
# full symbols for May, hollow symbols for October
pdf("images/guts-vs-eDNA_NMDS_euclidean.pdf")
...
raref.kick = as.data.frame(raref.kick %>% group_by(site, time) %>% summarise_all(funs(sum)))

rownames(raref.kick) = paste(raref.kick$site, raref.kick$time, sep="_")
raref.kick[is.na(raref.kick)] <- 0
raref.kick = t(raref.kick[,!c(colnames(raref.kick) %in% c("site","time"))])

inext.kick = iNEXT(raref.kick, q=c(0,1), datatype = "abundance", se=T, endpoint=1400)
...
# full symbols for May, hollow symbols for October
pdf("images/kick-samples_NMDS_bray-curtis.pdf")
...
```{r}
# full symbols for May, hollow symbols for October
pdf("images/kick-eDNA_NMDS_bray-curtis.pdf")
