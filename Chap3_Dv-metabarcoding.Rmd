...
dist.full = vegdist(adonis.full, method="euclidean")

adonis(dist.full~fact_site.full*fact_time.full*fact_type.full, permutations = 10000, method="euclidean")
```

```{r nmds based on distances and on abundance data}
# NMDS based on the distance matrix
meta.guts.edna = metaMDS(dist.full, trymax=200, distance="euclidean")
