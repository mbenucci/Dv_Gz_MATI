...
png("R_images/guts_Dvil_time_NMDS_euclidean.png", width = 500, height = 500, units = "px")
...
dev.off()
# full symbols for May, hollow symbols for October
png("R_images/guts_Dvil_only_NMDS_euclidean.png", width = 500, height = 500, units = "px")
...
# full symbols for May, hollow symbols for October
png("R_images/guts_predator_NMDS_euclidean.png", width = 500, height = 500, units = "px")
...
# full symbols for May, hollow symbols for October
png("R_images/eDNA_NMDS_bray-curtis.png", width = 500, height = 500, units = "px")
...
# full symbols for May, hollow symbols for October
png("R_images/kick-samples_NMDS_bray-curtis.png", width = 500, height = 500, units = "px")
...
adonis.kick.edna = abund.kick.edna[,!c(colnames(abund.kick.edna) %in% c("site","sample_id","sample_type","time"))]
...
# full symbols for May, hollow symbols for October
png("R_images/kick-eDNA_NMDS_bray-curtis.png", width = 500, height = 500, units = "px")
...
png("R_images/kick-eDNA_site-NMDS_bray-curtis.png", width = 500, height = 500, units = "px")
plot(meta.kick.edna, type="n", main="b) Community NMDS\neDNA and kick-samples by site", xlim=c(-1,1), ylim=c(-1,1))
points(meta.kick.edna, select=which(fact_site.edki[,1]=="WB" & fact_time.edki[,1]=="May"),col="black",pch=20)
points(meta.kick.edna, select=which(fact_site.edki[,1]=="WB" & fact_time.edki[,1]=="Oct"),col="black",pch=1)
points(meta.kick.edna, select=which(fact_site.edki[,1]=="GW" & fact_time.edki[,1]=="May"),col="blue",pch=22)
points(meta.kick.edna, select=which(fact_site.edki[,1]=="GW" & fact_time.edki[,1]=="Oct"),col="blue",pch=15)
...
png("R_images/Dvil_niche_breadth.png", width=500, height=500, units="px")
