...
fact_all.nmds = matrix(c(abund.guts$site, abund.guts$time, abund.guts$predator_id), ncol=3)

adonis(adonis.guts~fact_site.guts*fact_time.guts, permutations = 10000, method="bray")
adonis(adonis.guts~fact_predator.guts*fact_time.guts, permutations = 10000, method="bray")
adonis(adonis.guts~fact_predator.guts*fact_time.guts*fact_site.guts, permutations = 10000, method="e")
```

```{r nmds based on distances and on abundance data}
# NMDS based on the abundance data (will give the species scores as well)
meta.ad.guts = metaMDS(adonis.guts, trymax=200, distance="euclidean")
```
