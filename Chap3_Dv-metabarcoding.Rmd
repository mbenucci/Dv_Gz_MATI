...
Based on the levels of contamination in the Positive samples, the threshold levels were decided to be respectively 0.5% (May data set) and 0.5% (October data set). In May data set we still detect some _D. villosus_ contamination.
...
filter.may[grep("RB", rownames(filter.may)),"Dikerogammarus_villosus"]
clean.may[grep("RB", rownames(filter.may)),"Dikerogammarus_villosus"]
```
