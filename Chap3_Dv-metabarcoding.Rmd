...
clean.may17 = subset(dv.may17, select = log10(colSums(dv.may17)) >= may.depth.thre)
clean.oct17 = subset(dv.oct17, select = log10(colSums(dv.oct17)) >= oct.depth.thre)
...
Removal of unwanted taxa before continuing with contamination
