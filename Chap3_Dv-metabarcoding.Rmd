...
plot(fit.oct, labels = list(rownames(ord$species)))
ordiellipse(ord, group=rownames(ord$points), label=T, kind="ehull")
dev.off()
```
...
occup.melt[grep("Asellus|Corophium|Crangonyx|Dikerogammarus|Gammaridae|Gammarus", occup.melt$variable), "order"] = "Crustacea"
...
cols_barplot = c("darkorange", "cyan3", "gold4", "plum2", "red", "gray25", "yellow", "sandybrown",  "springgreen","tomato","palevioletred","darkcyan","khaki4","darkorchid3","gainsboro","tan4", "brown","grey48","black","darkgreen","khaki3","blue")
