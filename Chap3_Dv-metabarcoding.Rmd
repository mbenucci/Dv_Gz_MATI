...
miss.may
View(filter.may[rownames(filter.may) %in% miss.may,])

filter.may$predator_id[rownames(filter.may) %in% "WB.507"] = "Dikerogammarus_villosus"
filter.may$predator_id[rownames(filter.may) %in% c("RB.304","RB.303")] = "Corophium_multisetosum"
filter.may$predator_id[rownames(filter.may) %in% c(miss.may[!miss.may %in% c("WB.507","RB.304","RB.303")])] = "Gammarus_zaddachi"
