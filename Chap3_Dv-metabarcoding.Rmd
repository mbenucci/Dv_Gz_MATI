...
adonis(adonis.guts~fact_predator.guts*fact_time.guts*fact_site.guts, permutations = 10000, method="bray")
```

```{r nmds based on distances and on abundance data}
# NMDS based on the abundance data (will give the species scores as well)
meta.ad.guts = metaMDS(adonis.guts, trymax=200, distance="bray")
```
...
pdf("images/guts_predator2_NMDS.pdf")
