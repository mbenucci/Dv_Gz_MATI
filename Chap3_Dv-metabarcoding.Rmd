...
# NOTE!!! TO MOVE FROM OCCUPANCY TO ABUNDANCE FOR THE MICROSCOPY!!!
...
melt.kick[grep("Corophium|Crangonyx|Dikerogammarus|Gammaridae|Gammarus", melt.kick$variable), "order"] = "Amphipoda"
...
ggplot(melt.kick[c(melt.kick$order == "Amphipoda" & melt.kick$sample_type == "kick"),], aes(sample_id, value, group=time))+
