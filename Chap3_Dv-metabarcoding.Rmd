...
clean.guts = clean.guts[,!c(colnames(clean.guts) %in% c("Isopoda","Dikerogammarus_villosus"))]
...
#breadth.dvgz = as.data.frame(abund.guts[,!c(colnames(abund.guts) %in% c("time","site"))] %>% group_by(predator_id) %>% summarise_all(funs(sum)))
