...
filter.may[filter.may$sample_type == "gut","Dikerogammarus_villosus"] <- 0
clean.may[clean.oct$sample_type == "gut","Dikerogammarus_villosus"] <- 0
...
# Removing DNA read belonging to _D. villosus_ present in the gut contents due to wide spread contamination
filter.oct[filter.oct$sample_type == "gut","Dikerogammarus_villosus"] <- 0
clean.oct[clean.oct$sample_type == "gut","Dikerogammarus_villosus"] <- 0
