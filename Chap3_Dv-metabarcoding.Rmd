...
# Checking predator id assignment worked appropriately
...
# Oct
urow = rownames(filter.oct[filter.oct$predator_ID != "water", c("site","sample_id","time","sample_type","predator_id")])
