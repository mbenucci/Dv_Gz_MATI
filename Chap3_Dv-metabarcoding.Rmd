...
# Selecting only Grafham and Wroxham
melt.dvil.kick = melt.kick[grep("Dikerogammarus_sp|Dikerogammarus_villosus|Gammarus_sp.|Gammarus_tigrinus", melt.kick$variable),]

col_crustacea = c("#00CC99","#006666","#0000FF","#9966FF")

png("R_images/barplot_summary_amphipod.png", width = 3000, height = 3000, units = "px", res = 300)
ggplot(melt.dvil.kick[c(melt.dvil.kick$order == "Amphipoda" & melt.dvil.kick$site == c("GW","WB")),], aes(sample_id, value, group=time)) +
