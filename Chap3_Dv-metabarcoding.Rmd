...
points(meta.ad.guts, select=which(fact_site.guts[,1]=="WB"),col="black",pch=1)
points(meta.ad.guts, select=which(fact_site.guts[,1]=="GW"),col="blue",pch=22)
points(meta.ad.guts, select=which(fact_site.guts[,1]=="RB"),col="red",pch=25)
ordispider(meta.ad.guts,group=fact_site.guts[,1], col=c("green","orange","green4"),label=T)
ordiellipse(meta.ad.guts,group=fact_site.guts[,1],kind="ehull", lty=c(1,3),label=F,lwd=2)
dev.off()
```
