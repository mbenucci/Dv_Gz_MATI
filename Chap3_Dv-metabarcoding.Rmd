...
# envfit of community
plot(ord, type="n", xlim=c(-1.5,1.3), ylim=c(-1.3,1.1), cex.axis=2, cex.lab=1.5)
orditorp(ord, display="sites", col=c("blue","blue","blue","blue","blue","blue","darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","orange","orange","orange","orange","orange","orange"), cex=2)
