...
breadth.dv = abund.guts[abund.guts$predator_id == "D.vil",]
colnames(breadth.dv)

# summing prey DNA reads by predator ID and site.
breadth.dv = as.data.frame(breadth.dv[,!c(colnames(breadth.dv) %in% c("time","sample_type"))] %>% group_by(site,predator_id) %>% summarise_all(funs(sum)))
...
breadth.dv[,1] = breadth.dv[,1]/102
breadth.dv[,2] = breadth.dv[,2]/114
