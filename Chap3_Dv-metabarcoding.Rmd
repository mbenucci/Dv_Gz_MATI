...
lay.matrix = matrix(c(1,2,3,0,4,4), ncol=2, nrow=3, byrow=T)
...
lay.matrix = matrix(c(1,0,2,3,4,4), ncol=2, nrow=3, byrow=T)
layout(lay.matrix, heights=c(2,2,1), widths=c(2,2))
...
ordiellipse(meta.guts,group=fact_predator.guts[,1],kind="ehull",lty=c(1,5),label=F,lwd=1)
ordispider(meta.guts,group=fact_predator.guts[,1],col=c("blue","orange"),label=T)
text(1,-1.2,label=paste0("Stress: ",round(meta.guts$stress, 4)), cex=1.5)
text(-1.8, 1.4, label="a)", cex=3)
text(-1.1, 0.6, label="D.villosus", cex=2.5)
text(1, 1.5, label="G.zaddachi", cex=2.5)
