...
plot.new()
legend("top", legend=c("Grafham Water (May)","Grafham Water (Oct)","Wroxham Broad (May)","Wroxham Broad (Oct)","Rockand Broad (May)","Rockand Broad (Oct)"), col=c("blue","blue","green","green","orange","orange"), pch=c(15,22,19,1,17,24), cex=2, ncol=3)
dev.off()
```
