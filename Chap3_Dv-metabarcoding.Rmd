...
points(ord, select=which(rownames(ord$points) == c("RB1","RB2","RB3","RB4","RB5","RB6")), col="orange", pch=24)
orditorp(ord, display="sites", cex=1, col=c("blue","blue","blue","blue","blue","blue","darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","darkgreen","orange","orange","orange","orange","orange","orange"))
...
ag = ggplot(occup.melt[c(occup.melt$order == "Amphipoda" & occup.melt$site == "GW"),], aes(sample_id, value))+
  ...
  theme(legend.position = "right")
bw = ggplot(occup.melt[c(occup.melt$order == "Amphipoda" & occup.melt$site == "WB"),], aes(sample_id, value))+
  geom_bar(stat="identity", position="stack", aes(fill=variable)) +
  scale_fill_manual(values = col_crustacea, name = "") +
  theme_bw() +
  facet_grid(.~time) +
  labs(x="", y="Crustacea taxa occupancy (count)") + #, title = "Crustacea composition in samples") +
  theme(legend.position = "right")
cr = ggplot(occup.melt[c(occup.melt$order == "Amphipoda" & occup.melt$site == "RB"),], aes(sample_id, value))+
  geom_bar(stat="identity", position="stack", aes(fill=variable)) +
  scale_fill_manual(values = col_crustacea, name = "") +
  theme_bw() +
  facet_grid(.~time) +
...
grid.arrange(ag, bw, cr, ncol=1, nrow=3)
