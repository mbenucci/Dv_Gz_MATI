...
# setting rownames and removing extra variables
head(abund.kick)
raref.kick = abund.kick
rownames(raref.kick) = paste(raref.kick$sample_id, raref.kick$time, sep="_")
colnames(raref.kick)
inext.kick = t(raref.kick[,!c(colnames(raref.kick) %in% c("site","time","sample_id","REPLICATE","sample_type"))])

inext.kick = iNEXT(inext.kick, q=c(0,1), datatype = "abundance", se=T, endpoint=200)
