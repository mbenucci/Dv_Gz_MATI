...
Of these, between 99.4% and 100% belonged to _Dikerogamamrus villosus_. This is far less than ideal considering those are meant to be dissection and extraction blanks; and also in the perspective that the rest of the non-invaded Rockland Broad (RB) gut content samples presented very low _D. villosus_ contamination.

```{r}
# cleaning contamination in extraction blank samples
rowSums(clean.oct[grep("BL", rownames(filter.oct)),])
colSums(clean.oct[grep("BL", rownames(filter.oct)),])
