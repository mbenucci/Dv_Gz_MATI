...
matrix.guts = as.matrix(abund.guts[,!c(colnames(abund.guts) %in% c("time","site","type","predator_id"))])
...
dist.guts = vegdist(matrix.guts, method="euclidean")
...
```{r}
meta.guts = metaMDS(dist.guts, zerodist=ignore, trymax=200, distance="euclidean")
```
