...
food.web = as.data.frame(abund.guts[,!c(colnames(abund.guts) %in% c("sample_type","time"))] %>% group_by(site, predator_id) %>% summarise_all(funs(sum)))
rownames(food.web) = paste(food.web$predator_id, food.web$site, sep="_")
#, food.web$time
food.web = food.web[,!c(colnames(food.web) %in% c("site","predator_id"))]
...
seq.high=c("D.vil_GW","D.vil_WB","G.zad_RB")
...
col.network=c("yellow","yellow","tan4","tan4","darkorchid3","darkorchid3","red","yellow","cyan3","cyan3","cyan3","red","tan4","tan4","tan4","red","red","red","yellow","darkcyan","darkcyan","tan4","tan4","grey48","darkgreen","darkgreen","khaki3","yellow","yellow","darkorchid3")
```
