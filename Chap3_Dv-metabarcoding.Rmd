...
adonis(adonis.guts~fact_site.guts*fact_time.guts, permutations = 1000, method="bray")
adonis(adonis.guts~fact_predator.guts*fact_time.guts, permutations = 1000, method="bray")
adonis(adonis.guts~fact_predator.guts*fact_time.guts*fact_site.guts, permutations = 1000, method="bray")
adonis2(adonis.guts~fact_predator.guts*fact_time.guts*fact_site.guts, permutations = 1000, method="bray")
```

```{r nmds based on distances and on abundance data}
# NMDS based on the abundance data (will give the species scores as well)
meta.ab.guts = metaMDS(adonis.guts, distance="euclidean")
```
...
adonis(dist.full~fact_site.full*fact_time.full*fact_type.full, permutations = 10000, method="bray")
```
...
# NMDS based on the abundance data (will give the species scores as well)
meta.abund.guts.edna = metaMDS(adonis.full, trymax=200, distance="bray")
```
...
pdf("images/guts-vs-eDNA_NMDS.pdf")
...
dist.niche = vegdist(matrix.niche, method="bray")
