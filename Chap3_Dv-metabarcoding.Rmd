...
# 2. Diversity indexes of gut contents and eDNA community
...
```{r}
## FROM HERE!!!!
# NOTE: Issues to solve are in calculating the prey ratio in the guts. Too many NaN appears...I've seen this already, so check Harmonia script!
