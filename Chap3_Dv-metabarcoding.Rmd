...
text(-1,-0.8,label=paste("Stress:", round(meta.dv.guts$stress, 6)))
dev.off()
```
...
text(-0.6,-0.4, label=paste0("Stress: ", round(meta.ab.kick$stress,6)))
dev.off()
```
...
plot(meta.kick.edna, type="n", main="kick-samples NMDS", xlim=c(-1,1), ylim=c(-1,1))
