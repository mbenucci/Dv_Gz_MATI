...
plot(meta.guts, type="n", main="D.villosus and G.zaddachi gut contents NMDS")#, xlim=c(-2,1.5), ylim=c(-1.2,1.2))
...
plot(meta.dv.guts, type="n", main="D.villosus gut contents NMDS", xlim=c(-1,1.8), ylim=c(-1,1))
