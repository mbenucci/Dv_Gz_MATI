...
inext.guts = t(abund.guts[,!c(colnames(abund.guts) %in% c("site","time","predator_id"))])
...
dist.nmds = vegdist(matrix.nmds, method="euclidean")

adonis(dist.nmds~fact_site.nmds*fact_type.nmds, permutations = 10000, method="euclid")
adonis(dist.nmds~fact_time.nmds*fact_type.nmds, permutations = 10000, method="euclid")
```
