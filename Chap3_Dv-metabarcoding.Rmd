...
```{r prey detection in guts}
full.guts = cbind(ratio.guts, info.guts)
full.guts = full.guts[full.guts$predator_id %in% c("Dikerogammarus_villosus","Gammarus_zaddachi"),]
melt.guts = melt(full.guts)
```
