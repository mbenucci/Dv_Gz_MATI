...
```{r}
clean.may$Crangonyx_floridanus + clean.may$Crangonyx_pseudogracilis
clean.oct$Crangonyx_floridanus + clean.oct$Crangonyx_pseudogracilis
...
gen.sp.edna$sample_id
View(gen.sp.edna[gen.sp.edna$sample_id == "eWBBL",])
