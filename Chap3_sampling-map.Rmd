...
png("maps/Site_locations.png", width=1000, height=800, units="px")
ggplot(uk_map) +
  geom_polygon(aes(long,lat,group = group), fill="white", color="black") +
  geom_point(data=lakes.coords, aes(Longitude,Latitude), color="black") +
  coord_cartesian(xlim=c(-10,2),ylim=c(50,60)) +
  theme_minimal()
dev.off()
