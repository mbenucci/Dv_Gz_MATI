...
pack.list = c("broom","devtools","dplyr","ggplot2","ggsn","leaflet","maptools","mapview","raster","RColorBrewer","rgdal","rgeos","rworldmap","tmap")
...
## FROM HERE!!! ISSUES IN PLOTTING AES IN GGPLOT2 FOR MAPPING
...
```{r}
test[test@data$ADMIN == "United Kingdom",]
